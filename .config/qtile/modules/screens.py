    ...
    Screen(
        top=bar.Bar(
            [
                ...
                widget.Image(filename='~/.config/qtile/g8652-by-ondoho.png', margin=3, background="#2f343f",
                ...
                widget.TextBox(
                    ...
                    mouse_callbacks={
                        ...
                        lambda: qtile.cmd_spawn(
                            os.path.expanduser('~/Downloads/BL'))
                    },
                    foreground='#e39378'
                ),
                widget.TextBox(
                    ...
                    mouse_callbacks={
                        'Button1':
                        lambda: qtile.cmd_spawn(os.path.expanduser('obs'))
                    },
                    foreground='#ffffff'
                ),
                widget.Pomodoro(),
